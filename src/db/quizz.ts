...
export const quizzData: { [key: string]: QuizzData[] } = {
      easy: [
        ...
        },
        {
          ...
          choose: ["Great White Shark", "Whale Shark", "Hammerhead Shark", "Tiger Shark"],
          ans: 1,
        },
        {
  ...
  medium: [
    {
      ...
      choose: ["Leatherback turtle", "Green sea turtle", "Loggerhead turtle", "Hawksbill turtle"],
      ans: 0,
    },
    {
      image: require("../assets/whale.png"),
    ...
    },
    {
      ...
      choose: ["Tiger shark", "Hammerhead shark", "Bull shark", "Great white shark"],
      ans: 1,
    },
    {
    ...
    },
    {
      ...
      choose: ["Protection from predators", "Food source", "Shelter", "Reproduction assistance"],
      ans: 0,
    } 
  ],
  hard: [
    {
      ...
      choose: ["Box Jellyfish", "Lion's Mane Jellyfish", "Portuguese Man o' War", "Moon Jellyfish"],
      ans: 1,
    },
    {
      image: require("../assets/whale.png"),
    ...
    },
    {
      ...
      choose: ["They lay eggs in nests", "The male carries and gives birth to the young", "They reproduce through budding", "The female carries the young in her mouth"],
      ans: 1,
    },
    {
      image: require("../assets/icefish.png"),
      ques: "What adaptation allows the Antarctic Icefish to survive in freezing waters?",
      choose: ["Antifreeze proteins in their blood", "Thick blubber layer", "Ability to generate heat", "Hibernation during winter"],
      ans: 0,
    },
    {
    ...
    },
    {
      ...
      choose: ["Detecting light", "Sensing vibrations and movement in the water", "Aiding in digestion", "Breathing"],
      ans: 1,
    },
    {
      image: require("../assets/red.png"),
      ques: "What causes the phenomenon known as red tide?",
      choose: ["A large number of jellyfish", "Overgrowth of algae", "Migration of red crabs", "Pollution from ships"],
      ans: 1,
    },
  ],
};
